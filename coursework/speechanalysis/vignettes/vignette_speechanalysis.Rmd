...
'**Chris**' refers to Chris Vreeland, the major of Hoyt Lakes, Minnesota. All mentions of Chris are from a single statement where Trump is thanking him.

### Fayetteville, North Carolina
'**Rush**' refers to Rush Limbaugh, an American radio personality. All mentions of Rush in this speech are instances where Trump is praising him for his support.
...
'**John**' and '**James**' refers to John James, the Michigan U.S. Senate candidate Trump is endorsing.
...
'**Timber**': The timber industry is prominent in Wisconsin, Trump mentions how he has saved _"many timbenr jobs in [Wisconsin]"_.
...
'**Grabbed**' - Trump talks about how the National Guard handled the riots: _"They grabbed ones guy...they throw him aside like he was a little bag of popcorn...it's a beautiful sight."_

'**Lid**' - Joe Biden called a 'lid', which is a term used by reporteds when a politician has finished travelling for the day.
