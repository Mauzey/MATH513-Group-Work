...
<!-- SPEAKER NOTES
  From our analysis we can draw the following conclusions:
    ...
    Historical twitter data can be used effectively to analsye the public opinions and sentiments about a particular topic. 
    
    Due to the nature of Twitter data being current, it is therefore possible for businesses like Samsung and Apple to perform live analysis of the public's opinion around the release of a new product to get instant feedback and determine the ealy success of the release.

    The sentiment analsysis performed shows that the extra development and improvement of the S20FE over the S20 did lead to an increase in sentiments scores. 

    Feature sentiment analysis demonstrated that while the overall sentiment was higher for the S20FE there were some areas where there was a physical change to the device but no noticeable increase in sentiment.
    
    This can be seen when examining the sentiment towards the battery where it has remained similar or the camera where the decreased physical performance has led to a lower sentiment score.  
