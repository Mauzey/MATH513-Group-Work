...
```{r GeographicalDataIphone12, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8, fig.height=4.5}
...
```{r Geographical Data S20FE, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8, fig.height=4.5}
...
```{r Geographical Data S20, echo=FALSE, warning=FALSE, message=FALSE, fig.width=8, fig.height=4.5}
