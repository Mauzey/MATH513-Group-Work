...
!!!! TANIA TO INSERT GRAPH SHOWING SENTIMENT OF ALL TWEETS
...
Boxplot only looks at sentiment of tweets that contained one of the 5 key features that we wanted to examine. 
...
!!!!! TANIA TO PUT IN SLIDE ABOUT total_tweets
