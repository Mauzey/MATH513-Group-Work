...
# IMPORT DEPENDENCIES -------------------------------------------------------------------------------------------------------
libs <- c('readr', 'dplyr', 'tidyverse', 'tidyr', 'tidytext', 'modelr', 'stringr', 'rtweet', 'ggplot2', 'ggthemes','scales', 'knitr', 'rworldmap')
...
>>>>>>> 7c31d4edd9ca2b74ed218adf0b464d05919617e1
```
...
<!--- SPEAKER NOTES:
  ...
  - We extracted product features from each of the tweet's text:
    - These features were: The product's Display, Camera, Battery, Price, and 5G Capabilities
  
  - Finally, sentiment score was calculated for each tweet, by computing a sentiment for each word in the tweet,
...
```{r Time_Series_Plots, echo=FALSE, fig.width=8, fig.height=4.5}
...
tweet_df <- tweets %>% mutate(date_created = as.Date(ymd_hms(tweets$created_at)))

tweet_df <- tweets %>% group_by(product, is_retweet, date_created) 
...
<!--- Slide  ------------------------------------------------------------------------------------------------------------->
## Results - Sentiment Globally - Iphone12

```{r Geographical Data Iphone12, echo=FALSE}
...
<!--- Slide  ------------------------------------------------------------------------------------------------------------->
## Results - Sentiment Globally - S20FE

```{r Geographical Data S20FE, echo=FALSE}
...
<!--- Slide 06 ------------------------------------------------------------------------------------------------------------->
## Results - Sentiment Globally - S20

```{r Geographical Data S20, echo=FALSE}
