...
<!--- SPEAKER NOTES - WILL
  ...
  Samsung and Apple were chosen as our competing businesses due to the recent release of their flagship phones, the S20FE and iPhone12. This meant we would have access to sufficient relevant data on Twitter to perform analysis upon.

  We chose to gather some extra tweets relating to the S20 to give us some comparable information for sentiment analysis and to determine if there was any improvement in sentiment from the S20 to the S20FE from the public's viewpoint. 
  ...
  To allow us to work professionally and on various parts of the project as a group, we decided to break up the code into sections and utilise GitHub to keep track on the project.
...
<!--- SPEAKER NOTES: - WILL
  ...
  Twitter provides its data through a number of APIs and after the Cambridge Analytica 'data breach', is one of the few social media platforms that has not limited the data provided through APIs (Ahemd, Dr. Wasim (2019))
  
  Twitter data can provide insights into the public's opinions and combined with the openness and the generous rate limiting of Twitter’s API, it can produce powerful results. (Young, Michelle (2017))

  We came to the conclusion that it was better to use hashtags instead of pulling data from profiles. This was to ensure we would get a wide range of opinions for a fairer analysis of the public's sentiment.

  For our hashtags, we looked to the Samsung Mobile page and identified that the hashtags #GalaxyS20 and #GalaxyS20FE were the offical hashtags used by Samsung.
  
  We then looked for the same information from Apple but found that since the Twitter account was hacked in July, Apple have not been keeping tweets on their Twitter page. (Swider, Matt (2020), TechRadar - https://www.techradar.com/news/twitter-hack-2020))
...
<!--- SPEAKER NOTES - Will
  ...
  We leanrt from this and corrected our code and pulled as much data as we could for the other two phone usings the premium 30 day function.
  ...
  From the graph, you can see that we managed to gather a reasonable amount of tweets and retweets over the month of November for both these phones.
